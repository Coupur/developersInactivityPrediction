...
class SimpleScheduler:
    ...
    def _try_commit(self, stream_name):
        ...
        while next_idx in pending:
            ...
            primary_key = self.STREAM_TABLES[stream_name][0]
            n_primary = 0
            ...
            # Update progress bar (one update per committed page)
            pbar_key = self.STREAM_PBAR.get(stream_name)
            if pbar_key and pbar_key in self.pbars and n_primary:
                self.pbars[pbar_key].update(n_primary)
